...
## кратка теория
 stack - стопка, например, стопка тарелок. Можно оттуда взять верхнюю или положить сверху, а также можно посмотреть верхнюю и положить обратно.

 queue - очередь, в нее можно встать, посмотреть первого в очереди, можно выйти

 Linked List - связный список, например, цепочка людей где следуюший знает следующего
...
![Картинка1](../../images/lab_10/task_1.png)
...
![Картинка1](../../images/lab_10/task_2.png)